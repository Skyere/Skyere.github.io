export const environment = {
  ...
  backendLink: 'https://greencity-prod.azurewebsites.net/',
  backendChatLink: 'https://greencity-chat-prod.azurewebsites.net/',
  backendUserLink: 'https://greencity-user-prod.azurewebsites.net/',
  backendUbsLink: 'https://greencity-ubs-prod.azurewebsites.net',
  frontendLink: 'https://greencity-front-prod.azurewebsites.net/GreenCityClient/',
  socket: 'https://greencity-prod.azurewebsites.net/socket',
